...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_cont_2, 409, 182);
    lv_obj_set_size(ui->screen_cont_2, 386, 292);
    ...
    lv_obj_set_pos(ui->screen_roller_1, 8, 173);
    ...
    lv_obj_set_style_text_font(ui->screen_roller_1, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_cont_1, 409, 9);
    lv_obj_set_size(ui->screen_cont_1, 385, 166);
    ...
    lv_obj_set_pos(ui->screen_sw_1, 85, 138);
    ...
    lv_obj_set_pos(ui->screen_label_1, -6, 138);
